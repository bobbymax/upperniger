...
export const collectAll = (entity) => {
  const res = axios.get(`${API_ENDPOINTS.url}` + entity, {
    headers: authHeader(),
  });
...
export const store = (entity, body) => {
  const res = axios.post(`${API_ENDPOINTS.url}` + entity, body, {
    headers: authHeader(),
  });
  return Promise.resolve(res);
};
...
export const fetcher = (entity, id) => {
  const res = axios.get(`${API_ENDPOINTS.url + entity}/${id}`, {
    headers: authHeader(),
  });
  return Promise.resolve(res);
};

export const customFetch = (path) => {
  const res = axios.get(`${API_ENDPOINTS.url + path}`, {
    headers: authHeader(),
  });
  return Promise.resolve(res);
};
...
export const alter = (entity, id, body) => {
  const res = axios.patch(`${API_ENDPOINTS.url + entity}/${id}`, body, {
    headers: authHeader(),
  });
  return Promise.resolve(res);
};
...
export const destroy = (entity, id) => {
  const res = axios.delete(`${API_ENDPOINTS.url + entity}/${id}`, {
    headers: authHeader(),
  });
  return Promise.resolve(res);
};
